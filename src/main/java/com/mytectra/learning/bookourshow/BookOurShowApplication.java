 ...
 *
 */
@SpringBootApplication(scanBasePackages = "com.mytectra" )
@EnableWebMvc
public class BookOurShowApplication {
	...
	public static void main(String[] args) throws TicketingExecption {
		 ...
		 * 
		 * Movie movie = new Movie(); movie.setId(12); movie.setMovieName("Rambo");
		 * 
		 ...
		 * System.out.println(String.format("Discount (%f%%) -  %f",booking.getDiscount(
		 * ) ,booking.getDiscountedPrice())); System.out.println("Tax - " +
		 * booking.getTax() + " Rs");
		 * System.out.println("------------------------------------");
		 * System.out.println("TOTAL - "+ booking.getGrandTotal());
		 * System.out.println("______________________________________"); for(String msg
		 * : booking.getOffersApplied()) { System.out.println("* "+msg); } for(String
		 * msg : booking.getPricingInfo()) { System.out.println("* "+msg); }
		 */
